...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Caller should be contract owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(!newOwner.isContract(), "Address is invalid");
        _owner = newOwner;
        emit NewOwner(_owner);
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "The new owner is the current owner of the token.");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((ownerOf(tokenId) == msg.sender) || (isApprovedForAll(ownerOf(tokenId), msg.sender)), "You are not the owner of the token.");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        // if(_exists(tokenId) || to.isContract()) {
        //     revert();
        // }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(!to.isContract(), "The destination address is not a valid address");
...
contract HousingERC721Token is ERC721Metadata("Housingtoken", "HOT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
